    ...
    <div className="">
      <div className=" h-[260px] md:h-[600px] object-cover ">
        <Carousel slideInterval={5000} className="rounded-none w-full">
          {slides.map((item, idx) => (
            <img key={idx} src={item} alt={`carouselImg${idx + 1}`} className="w-full"/>
          ))}
        </Carousel>
      </div>
      <div className="w-[75%] h-[60px] mt-[20px] ml-[45px] lg:w-[70%] lg:ml-[200px] lg:h-[120px] bg-[#A30001] text-white shadow-[#d68080] shadow-2xl rounded-[5px]">
